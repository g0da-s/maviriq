...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center px-6 pt-16">
      ...
      {/* ═══ HOW IT WORKS ═══ */}
      <div className="w-full max-w-3xl py-24 border-t border-card-border">
        <h2 className="font-display text-center text-2xl font-bold tracking-tight mb-12">
          how it works
        </h2>
        <div className="grid gap-8 sm:grid-cols-3">
          <div className="text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-card-border bg-card text-lg font-bold font-display">
              1
            </div>
      ...
      {/* ═══ SOCIAL PROOF ═══ */}
      <div className="w-full max-w-3xl py-16 border-t border-card-border text-center">
        <p className="text-4xl font-bold font-display">568</p>
        <p className="mt-1 text-sm text-muted">ideas analyzed and counting</p>
      </div>
    </div>
  );
}
